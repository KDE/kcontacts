...
#    define KABC_FILE_CORE_DEPRECATED_EXPORT KDE_DEPRECATED KABC_FILE_CORE_EXPORT
#    define KABC_FILE_CORE_DEPRECATED KDE_DEPRECATED
#  else
#    define KABC_FILE_CORE_EXPORT_DEPRECATED KABC_FILE_CORE_EXPORT
#    define KABC_FILE_CORE_DEPRECATED_EXPORT KABC_FILE_CORE_EXPORT
#    define KABC_FILE_CORE_DEPRECATED
#  endif
# endif
# ifndef KABC_DIRECTORY_EXPORT_DEPRECATED
#  if !defined( WANT_DEPRECATED_KABC_API )
#    define KABC_DIRECTORY_EXPORT_DEPRECATED KDE_DEPRECATED KABC_DIRECTORY_EXPORT
#    define KABC_DIRECTORY_DEPRECATED_EXPORT KDE_DEPRECATED KABC_DIRECTORY_EXPORT
#    define KABC_DIRECTORY_DEPRECATED KDE_DEPRECATED
#  else
#    define KABC_DIRECTORY_EXPORT_DEPRECATED KABC_DIRECTORY_EXPORT
#    define KABC_DIRECTORY_DEPRECATED_EXPORT KABC_DIRECTORY_EXPORT
#    define KABC_DIRECTORY_DEPRECATED
#  endif
# endif
# ifndef KABC_NET_EXPORT_DEPRECATED
#  if !defined( WANT_DEPRECATED_KABC_API )
#    define KABC_NET_EXPORT_DEPRECATED KDE_DEPRECATED KABC_NET_EXPORT
#    define KABC_NET_DEPRECATED_EXPORT KDE_DEPRECATED KABC_NET_EXPORT
#    define KABC_NET_DEPRECATED KDE_DEPRECATED
#  else
#    define KABC_NET_EXPORT_DEPRECATED KABC_NET_EXPORT
#    define KABC_NET_DEPRECATED_EXPORT KABC_NET_EXPORT
#    define KABC_NET_DEPRECATED
#  endif
# endif
# ifndef KABC_LDAPKIO_EXPORT_DEPRECATED
#  if !defined( WANT_DEPRECATED_KABC_API )
#    define KABC_LDAPKIO_EXPORT_DEPRECATED KDE_DEPRECATED KABC_LDAPKIO_EXPORT
#    define KABC_LDAPKIO_DEPRECATED_EXPORT KDE_DEPRECATED KABC_LDAPKIO_EXPORT
#    define KABC_LDAPKIO_DEPRECATED KDE_DEPRECATED
#  else
#    define KABC_LDAPKIO_EXPORT_DEPRECATED KABC_LDAPKIO_EXPORT
#    define KABC_LDAPKIO_DEPRECATED_EXPORT KABC_LDAPKIO_EXPORT
#    define KABC_LDAPKIO_DEPRECATED
#  endif
# endif
