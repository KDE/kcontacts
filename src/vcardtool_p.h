...
public:
    ...
    /*!
      ...
      the vCard format.
     */
    [[nodiscard]] QByteArray createVCards(const Addressee::List &list, VCard::Version version = VCard::v3_0) const;

    /*!
     * \since 4.9.1
     */
    [[nodiscard]] QByteArray exportVCards(const Addressee::List &list, VCard::Version version = VCard::v3_0) const;
    /*!
